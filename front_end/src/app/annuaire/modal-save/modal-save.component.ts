    ...
    if (this.isEditMode) {
      ...
      switch (this.type_client) {
        case 'organisation':
          ...
          // Set client_id before create/update
          this.singleOrganisation.client_id = this.singleClient.id;
          if (this.singleOrganisation.id) {
        ...
        case 'particulier':
          ...
          // Set client_id before create/update
          this.singleParticulier.client_id = this.singleClient.id;
          if (this.singleParticulier.id) {
        ...
        case 'agence':
          ...
          // Set client_id before create/update
          this.singleAgence.client_id = this.singleClient.id;
          if (this.singleAgence.id) {
