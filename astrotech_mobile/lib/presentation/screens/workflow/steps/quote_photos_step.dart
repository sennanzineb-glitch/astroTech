...
/// Quote Photos Step
/// Second step in the quote branch - capture photos for the quote
class QuotePhotosStep extends StatelessWidget {
  final List<InterventionPhoto> photos;
  final int interventionId;

  const QuotePhotosStep({
    super.key,
        ...
        Row(
          children: [
            Container(
              ...
              child: Icon(Icons.photo_camera, color: Colors.purple, size: 28),
            ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            AppStrings.quotePhotosInstruction,
            style: TextStyle(
              fontSize: 13,
              color: AppColors.textSecondary,
            ),
          ...
          const SizedBox(height: 8),
          Text(
            '• Photographiez la zone concernée\\n'
            '• Incluez les mesures si possible\\n'
            '• Montrez les contraintes techniques',
            style: TextStyle(
              fontSize: 12,
              color: AppColors.textSecondary,
              height: 1.5,
  ...
  Widget _buildValidationStatus() {
    ...
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: isValid ? Colors.green[50] : Colors.purple[50],
        borderRadius: BorderRadius.circular(8),
        border: Border.all(
          color: isValid ? AppColors.success : Colors.purple,
          width: 2,
        ),
      ),
      child: Row(
