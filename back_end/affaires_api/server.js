...
// === Mobile API ===
app.get(`${URI}/mobile/me`, authenticateToken, MobileController.getMobileProfile);
app.get(`${URI}/mobile/interventions`, authenticateToken, MobileController.getMobileInterventions);
app.get(`${URI}/mobile/interventions/:id`, authenticateToken, MobileController.getMobileInterventionDetail);
app.put(`${URI}/mobile/interventions/:id/status`, authenticateToken, MobileController.updateInterventionStatus);
app.post(`${URI}/mobile/interventions/:id/workflow`, authenticateToken, MobileController.updateInterventionWorkflow);
app.post(`${URI}/mobile/interventions/:id/photos`, authenticateToken, MobileController.uploadInterventionPhoto);
app.get(`${URI}/mobile/interventions/:id/photos`, authenticateToken, MobileController.getInterventionPhotos);
app.delete(`${URI}/mobile/interventions/:id/photos/:photoId`, authenticateToken, MobileController.deleteInterventionPhoto);
app.post(`${URI}/mobile/interventions/:id/signature`, authenticateToken, MobileController.uploadSignature);
app.get(`${URI}/mobile/interventions/:id/signatures/:type`, authenticateToken, MobileController.getTypedSignature);
app.post(`${URI}/mobile/interventions/:id/interruptions`, authenticateToken, MobileController.addInterventionInterruption);
app.put(`${URI}/mobile/interventions/:id/interruptions/:interruptionId`, authenticateToken, MobileController.updateInterventionInterruption);
app.put(`${URI}/mobile/interventions/:id/travel-time`, authenticateToken, MobileController.updateTravelTime);
app.post(`${URI}/mobile/sync`, authenticateToken, MobileController.mobileSync);
